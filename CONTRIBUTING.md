...
We use pull requests (PRs) to manage updates to the code base, and block merging of PRs unless automated tests pass (they're stored in the **flystim/tests** subdirectory).  Here are the steps to go through to use this system.
...
```
5. Go to the [flystim GitHub page](https://github.com/ClandininLab/flystim).
