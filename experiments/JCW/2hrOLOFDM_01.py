...
def main():
    ...
    OF2 = '/home/baccuslab/Videos/stimulus_videos/OF3.avi'
...
#         root_stim = NaturalMovie(memname, DM1, 29.97, TRAIN_DUR, logfile=logfile_path)
#         process = threading.Thread(target=root_stim.stream).start()
...
#         del root_stim,process
    ...
    for i in range(N_TRAIN):
        ...
        root_stim = NaturalMovie(memname, OF2, 29.97, TRAIN_DUR, logfile=logfile_path)
        process = threading.Thread(target=root_stim.stream).start()
