...
def main():
    ...
    trial_labels = np.array([1]) # visible, coherent. 00, 01, 10, 11
    n_repeats = 15
    save_path = "/home/clandinin/minseung/ballrig_data"
    save_prefix = "200728_fly8_fixation_3deg"
    ...
    presample_duration = 60 #seconds
    sample_duration = 0 #seconds
    preocc_duration = 0 #seconds
    occlusion_duration = 0 #seconds
    postocc_duration = 0 #seconds
