...
def main():
    ...
    dtheta = 10*np.random.normal(size=100) # degrees
    ...
    height = 1.0
    manager.load_stim(name='Tower', color = [1, 0, 0, 0.5], cylinder_height=height, cylinder_radius=0.1, cylinder_location=[1,1,0], hold=True)
    manager.load_stim(name='Tower', color = [0, 1, 0, 0.5], cylinder_height=height, cylinder_radius=0.1, cylinder_location=[-1,1,0], hold=True)
    manager.load_stim(name='Tower', color = [0, 0, 1, 0.5], cylinder_height=height, cylinder_radius=0.1, cylinder_location=[-1,-1,0], hold=True)
    manager.load_stim(name='Tower', color = [1, 1, 1, 0.5], cylinder_height=height, cylinder_radius=0.1, cylinder_location=[1,-1,0], hold=True)
